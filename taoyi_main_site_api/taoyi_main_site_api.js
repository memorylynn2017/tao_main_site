...
base.init(center_url , specific_port)
    .then( port => {
        base.log(null, "info" , "taoyi_main_site_api" , "base init 完成. express正在启动",null)
        ...
        app.use(function (err, req, res, next) {
            ...
            if(err){
                base.log(null, "error" , "taoyi_main_site_api", "未处理的异常",err);
            }           
        ...
        server.on('listening', function () {
            ...
            base.log(null, "info" , "taoyi_main_site_api" , `****管理后台， 在端口【 ${port} 】监听****`,null)
        })
